    ...
    <div>
        ...
        <div class="container">
            ...
            <el-table :data="table_data" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column label="英雄唯一ID" align="center">
                    <template slot-scope="scope">{{scope.row.huid}}</template>
                </el-table-column>
                <el-table-column label="英雄ID">
                    <template slot-scope="scope">{{scope.row.heroid}}</template>
                </el-table-column>
                ...
                <el-table-column label="技能等级"  >
                    <template slot-scope="scope">{{scope.row.skilllevel}}</template>
                </el-table-column>
                <el-table-column label="阶级"  >
...
export default {
    ...
    methods: {
        getData(getCount) {
            ...
            request.post('./heroQuery',this.query).then(res => {
